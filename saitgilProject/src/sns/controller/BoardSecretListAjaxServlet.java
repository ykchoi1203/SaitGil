...
/**
 * Servlet implementation class BoardSecretListAjaxServlet
 */
@WebServlet("/secretAjax.bo")
public class BoardSecretListAjaxServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BoardSecretListAjaxServlet() {
        super();
