...
/**
 * Servlet implementation class ShoppingProductListServlet
 */
@WebServlet("/pList.sp")
public class ShoppingProductListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShoppingProductListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		int listCount = new ShoppingService().getListCount();
		...
		int boardLimit = 12; // 한 페이지에 보여질 게시글 최대 갯수
		...
		ArrayList<Product> list = new ShoppingService().selectList(currentPage, boardLimit);
		...
		request.getRequestDispatcher("views/shopping/shoppingProductList.jsp").forward(request, response);
	}
