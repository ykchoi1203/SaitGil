			...
			<div class="container">
				<div class="row">
					<div class="col-md-12" style="width: 1000px;">
						<h1 class="page-head-line">ADD Notice</h1>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
						<div class="panel panel-default" style="width: 950px;">
							...
							<div class="panel-body">
								<form action='<%= request.getContextPath()%>/insertNotice.ad' method='post'>
									...
									<div class="form-group">
										...
										<div  style='width: 900px; height: 500px;'>
											<textarea name="nContent" cols='130' rows='25' style="resize:none;"></textarea>
										</div>
									</div>
									<div align=right>
										<button type="submit" class="btn btn-default">공지사항 추가</button>
