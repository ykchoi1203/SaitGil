    ...
    <div class="all">
        <div class="container">
            <div id="viewPoint" style=" margin-top:5px;">
                <div class="category" style="background:pink;" onclick="location.href='<%= request.getContextPath()%>/list.bo'">모두 보기</div>
                <div class="category" onclick="location.href='<%= request.getContextPath()%>/secretList.bo'">비밀 글 보기</div>
                <div class="category" onclick="location.href='<%= request.getContextPath() %>/likeList.bo?userId=<%= loginUser.getUserId() %>'">좋아요 한 목록 보기</div>
                <div class="category" onclick="location.href='<%= request.getContextPath() %>/scrapList.bo?cCode=<%= loginUser.getcCode() %>'">스크랩 보기</div>
                <br><br>
                <div class="category-detail">
                    <div class="share-category" onclick="location.href='<%= request.getContextPath()%>/list.bo'">전체 보기</div>
                    <div class="share-category" style="background:pink;" onclick="location.href='<%= request.getContextPath() %>/myList.bo?userName=<%= loginUser.getUserName() %>'">내가 쓴 글 보기</div>
                </div>
            </div>
            <script>
                 /* $(function(){
