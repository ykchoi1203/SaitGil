        ...
        <div class="container">
            <div id="viewPoint" style=" margin-top:5px;">
                ...
                <div class="category-detail">
                    <div class="share-category" style="background:pink;" onclick="location.href='<%= request.getContextPath()%>/list.bo'">전체 보기</div>
                    <div class="share-category" onclick="location.href='<%= request.getContextPath() %>/myList.bo?userName=<%= loginUser.getUserName() %>'">내가 쓴 글 보기</div>
                </div>
            </div>
            <script>
                 /* $(function(){
