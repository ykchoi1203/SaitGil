    ...
    <div class="all">
        <div class="container">
            <div id="viewPoint" style=" margin-top:5px;">
                ...
                <div class="category" style="background:pink;" onclick="location.href='<%= request.getContextPath() %>/scrapList.bo?cCode=<%= loginUser.getcCode() %>'">스크랩 보기</div>
            </div>
            <script>
                 /* $(function(){
