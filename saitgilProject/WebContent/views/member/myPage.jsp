...
<div class="main">
    <div class="container">
                    ...
                    <form id="updateForm" action="<%= request.getContextPath() %>/update.me" method="post" onsubmit="return joinValidate();" class="register-form" >
                        ...
                        <div class="form-row">
                            <div style="width:300px; height:150px; padding:30px; align:center;">
                                <img src="<%= loginUser.getProfilePic() %>" id="myPhoto" style="width:150px; height:150px; margin:auto;"> <br>
        ...
        <script>
	    	function goBack() {
	    		location.href="<%= request.getContextPath() %>/loginMainPage.me";
	    	}
	    	...
	    	function deleteProfile(){
	    		if(confirm("정말로 삭제하시겠습니까?")) {
	    			var path = "resources/images/profile_boy.png";
	    			if("<%= loginUser.getGender() %>" == 'F') {
	    				path = "resources/images/profile_girl.png";
	    			}
					$.ajax({
